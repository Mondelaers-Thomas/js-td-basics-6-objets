...
moi.etatCivile = "marié";

console.log(moi);
console.log(`Je m'appelle ${moi.nom} ${moi.prenom} j'ai ${moi.age} ans, je suis ${moi.profession} et je suis ${moi.nationalite} et je suis ${moi.etatCivile}`);
...
console.log(stylo);
console.log(`J'écris avec un stylo ${stylo.type}(type) ${stylo.couleur}(couleur) de marque ${stylo.marque}`);
